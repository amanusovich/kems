...
This fork adds a prover for intuitionistic propositional logic (the labelled KE system
of Solares-Rojas, Baldi and Rodriguez, J. Logic Comput. 36(6), 2026): code under
kems.prover/src/*/ipl, ILTP problems and benchmarks under benchmarks/ (see
benchmarks/README.md), web demo at https://kems-ipl.fly.dev/.
